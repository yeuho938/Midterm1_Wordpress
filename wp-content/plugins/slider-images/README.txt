...
Donate link: https://rich-web.org/wp-image-slider/
Tags: slider, wordpress slider, image slider, Photo Slider, slider plugin, responsive slider, easy slider, post slider, video slider, youtube slider, images slider,
...
= Image Slider plugin by RW =

* [Learn more about Rich Image Slider Plugin features.](https://rich-web.org/wp-image-slider/)
* [Slider Live Demo](https://rich-web.org/wp-image-slider-navigation/)
...
Let you to choose which shape fit to your site. Currently 10 different types and 50+ slide effects included.

* [Slider Navigation](https://rich-web.org/wp-image-slider-navigation/)
* [Content Slider](https://rich-web.org/wp-image-slider-content/)
* [Fashion Slider](https://rich-web.org/wp-image-slider-fashion/)
* [Circle Thumbnails](https://rich-web.org/wp-image-slider-carousel/)
* [Carousel](https://rich-web.org/wp-image-slider-carousel/)
* [Flexible Slider](https://rich-web.org/wp-image-slider-flexible/)
* [Dynamic Slider](https://rich-web.org/wp-image-slider-dynamic/)
* [Thumbnails Slider and Lightbox](https://rich-web.org/wp-image-slider-thumbnail-lightbox)
* [Accordion slider](https://rich-web.org/wp-image-slider-accordion/)
* [Animation Slider](https://rich-web.org/wp-image-slider-animation/)
...
### IMPORTANT:
If You think You have found a mistake in the Photo Slider or have any problem, questions about the plugin, please read the [Support Forum](https://wordpress.org/support/plugin/slider-images) on our WordPress website. If You can not find a solution here, please feel free and click here to [Contact US](https://rich-web.org/contact-us).
...
Click to add new button -> Search plugins. On empty line write your preferable plugin. [Example](https://rich-web.org/wp-image-slider/). Your preferable plugin you can find from WordPress large menu.
...
Watch Below Video For Free Version.
...
Extract the plugin directory to your computer.
...
Now you can set your plugin options, images and use our plugin.
...
1.  Click to add new button -> Search plugins. On empty line write your preferable plugin. Example. Your preferable WordPress image slider plugin you can find from WordPress large menu.
...
= How can I add pluginr in the widgets? =
	
*  Find the plugin in available widgets’ list, add it to your desired widget section by using drag and drop function or the drop down menu. Now, in the chosen section select your type from Rich-Web Slider drop down menu and save. After which watch the beautiful slider on your frontend.
...
* In The Navigation version adds the ability to link. Y0ou can click on the image to go to another page.
* In Accordion version the image problem is solved.

= 1.4.1 =

* Update Readme after testing plugin in WordPress 5.3.

= 1.4.0 =

* Changed some function in the option

= 1.3.9 =

* Changed: in Content type place of the description is more long.
* Changed: in the Responsive images were very small.
* Fixed bug: in Content type the link button was not displayed.

= 1.3.8 =

* Changed the design in the accordion associated with the heading.
* Fixed bug with popup.
* Fixed bug when several slider beat on the page, then the image on the pop-up was shown incorrectly.

= 1.3.7 =

* Fixed bug: The description of the dynamic type was not resized in responsive. 
* Fixed bug: Using the link in the content of the dynamic type there automatically worked hover effect.

= 1.3.6 =

* Fixed a problem. There were 2 sliders on one page.

= 1.3.5 =

* Added "Clever" Keyboard function in all sthemes
* Added swipe function in all themes.
* Added the ability to add videos (Youtube, Vimeo) in the slider. (Pro)
* Added new fonts
* In Accardion Type changed function with working on mobile devices.
* In Flexible Slider type fixed bug with arrow and title styles.
* Fixed CSS bugs in Circle Thumbnails type.
* Fixed bug with scrolling effect in Fashion Slider type.
* Fixed bug with popup content style.
* Fixed bug with responsiveness function.
* Fixed bug with working on mobile devices.
...
* Changed css styles for constructing Content Slider type.
...
* Fixed bug with flexible and dynamic types.
...
* Added hover effects in the carousel.
...
* Added new version. Animation Type.
* Added possibility to make duplicate for sliders and for settings.
...
* Multiple short codes in some types.

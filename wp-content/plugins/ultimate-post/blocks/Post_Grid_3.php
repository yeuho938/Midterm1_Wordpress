    ...
    public function get_attributes($default = false){
        ...
        $attributes = array(
            ...
            'column' => [
                ...
                'style' => [
                    (object)[
                        'selector'=>'{{ULTP}} .ultp-block-row { grid-template-columns: repeat({{column}}, 1fr); }'
                    ],
                ],
            ],
            'columnGridGap' => [
            ...
            'titleLgTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'30', 'unit'=>'px'], 'height'=>(object)[ 'lg'=>'36', 'unit'=>'px'],'decoration'=>'none','family'=>'','weight'=>'700'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
    ...
    public function register() {
        register_block_type( 'ultimate-post/post-grid-3',
            array(
                ...
                'description' => __( 'Post grid with top big posts overlay style.' ),
        ...
        if ($recent_posts->have_posts()) {
            $wraper_before .= '<div '.($attr['advanceId']?'id="'.$attr['advanceId'].'" ':'').' class="wp-block-ultimate-post-'.$block_name.' ultp-block-'.$attr["blockId"].' '.(isset($attr["className"])?$attr["className"]:'').'">';
                $wraper_before .= '<div class="ultp-block-wrapper">';
                    ...
                    $wraper_before .= '<div class="ultp-block-items-wrap ultp-block-row ultp-block-column'.$attr["column"].'">';
                        $idx = $noAjax ? 1 : 0;

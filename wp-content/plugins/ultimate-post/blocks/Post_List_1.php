            ...
            'contentAlign' => [
                ...
                'style' => [
                    ...
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-block-content-wrap { text-align:{{contentAlign}}; } {{ULTP}} .ultp-block-meta {justify-content: flex-end;}'
                    ],
                ],
            ],
    ...
    public function register() {
        register_block_type( 'ultimate-post/post-list-1',
            array(
                ...
                'description' => __( 'Listing your post with classic style.' ),

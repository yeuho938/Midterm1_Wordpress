...
class Post_Grid_2{
    ...
    public function get_attributes($default = false){
        ...
        $attributes = array(
            ...
            'catTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography' => 1, 'size' => (object)['lg' =>11, 'unit' =>'px'], 'height' => (object)['lg' =>15, 'unit' =>'px'], 'spacing' => (object)['lg' =>1, 'unit' =>'px'], 'transform' => 'uppercase', 'weight' => '400', 'decoration' => 'none','family'=>'' ],
                'style' => [
                    (object)[
                        'depends' => [
    ...
    public function register() {
        register_block_type( 'ultimate-post/post-grid-2',
            array(
                ...
                'description' => __( 'Post grid with gradient image overlay style.' ),

<?php
if (!class_exists('Newsever_Posts_Slider')) :
    /**
     * Adds Newsever_Posts_Slider widget.
     */
    class Newsever_Posts_Slider extends AFthemes_Widget_Base
    {
        /**
        ...
        {
            $this->text_fields = array('newsever-posts-slider-title', 'newsever-excerpt-length', 'newsever-posts-slider-number');
            ...
            $widget_ops = array(
                'classname' => 'newsever_posts_slider_widget aft-widget',
                'description' => __('Displays posts slider from selected category.', 'newsever'),
                'customize_selective_refresh' => false,
            );

            parent::__construct('newsever_posts_slider', __('AFTN Posts Slider', 'newsever'), $widget_ops);
        }
        ...
        public function widget($args, $instance)
        {
            ...
            $title = apply_filters('widget_title', $instance['newsever-posts-slider-title'], $instance, $this->id_base);
            $category = isset($instance['newsever-select-category']) ? $instance['newsever-select-category'] : 0;
            $number_of_posts = isset($instance['newsever-posts-slider-number']) ? $instance['newsever-posts-slider-number'] : 5;
            ...
            <div class="posts-slider banner-slider-2  af-post-slider af-widget-carousel slick-wrapper">
                    ...
                    if ($all_posts->have_posts()) :
                        while ($all_posts->have_posts()) : $all_posts->the_post();
                            global $post;
                            $url = newsever_get_freatured_image_url($post->ID, 'newsever-slider-full');
                            ?>
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::newsever_generate_text_input('newsever-posts-slider-title', __('Title', 'newsever'), 'Posts Slider');

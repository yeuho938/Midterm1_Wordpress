            ...
            if ($post_categories) {
                ...
                foreach ($post_categories as $post_category) {
                    ...
                    $output .= '<li class="meta-category">
                             <a class="newsever-categories ' . esc_attr($color_class) . '" href="' . esc_url(get_category_link($post_category)) . '" alt="' . esc_attr(sprintf(__('View all posts in %s', 'newsever'), $post_category->name)) . '"> 

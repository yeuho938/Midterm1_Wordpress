 ...
 */
function buzznews_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'buzznews_customize_register' );
 ...
 * @return void
 */
function buzznews_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function buzznews_customize_partial_blogdescription() {

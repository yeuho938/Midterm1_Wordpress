...
function buzznews_import_files() {
    return array(
      array(
        ...
        'import_file_url'            =>  'https://demo.spiderbuzz.com/deom-data/buzznews/content.xml',//
        'import_widget_file_url'     =>  'https://demo.spiderbuzz.com/deom-data/buzznews/widget.wie',
        'import_customizer_file_url' =>  'https://demo.spiderbuzz.com/deom-data/buzznews/customizer.dat',

 ...
 * */
class Buzznews_Sidebar_Mostread_List_Layout extends WP_Widget {

	/* Register Widget with WordPress*/
	function __construct() {
		parent::__construct(
			'buzznews_sidebar_mostread_post', // Base ID
			esc_html__( 'BN Sidebar: Most Read', 'buzznews' ), //Widget Name
	...
	public function form( $instance ) {
		$defaults = array(
			'title'			=> esc_html__( 'Most read', 'buzznews' ),
	...
	?>
        ...
        <div class="sidebar-mostread">
            <div class="buzznews-trendingnews-right">
                ...
                <?php endif; ?>
                <div class="sidebar-mostread-wrapper buzznews-vertical">
                    <?php 
                        /**
                         * args 
                         * 
                         * @since 1.0.0
                         */
                        $args = array( 'post_type'=>'post','posts_per_page'=>$number_posts,'cat'=>$home_blog_category_id, 'orderby' => 'meta_value_num', 'order' => 'DESC' );
                        $blog_query = new WP_Query( $args ); 

        
                        while( $blog_query->have_posts()): $blog_query->the_post(); 
						get_template_part( 'spiderbuzz/template-parts/home/mostread-list' );
...
function buzznews_sidebar_mostread_layout_config() {
    register_widget( 'Buzznews_Sidebar_Mostread_List_Layout' );
}
add_action( 'widgets_init', 'buzznews_sidebar_mostread_layout_config' );
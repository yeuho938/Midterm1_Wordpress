 ...
 * @package True News
 */
if ( !function_exists('true_news_category_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function true_news_category_widgets(){
        // Recent Post widget.
        register_widget('True_News_Sidebar_Category_Widget');
    }
endif;
add_action('widgets_init', 'true_news_category_widgets');
// Recent Post widget
if ( !class_exists('True_News_Sidebar_Category_Widget') ) :
    /**
     * Recent Post.
     *
     * @since 1.0.0
     */
    class True_News_Sidebar_Category_Widget extends True_News_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'true_news_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'true-news'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'true-news'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'true-news'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
            );
            parent::__construct('true-news-category-layout', esc_html__('BP: Category Widget', 'true-news'), $opts, array(), $fields);
        }
        /**

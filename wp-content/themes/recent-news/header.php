...
<div id="page" class="site">
    ...
    if (($refined_magazine_theme_options['refined-magazine-enable-post-carousel-below-slider'] == 1) && (is_front_page())):
        /**
         * refined_news_post_carousel_customizer hook.
         *
         * @since 1.0.0
         *
         */
        do_action('recent_news_post_carousel_customizer');
    endif;

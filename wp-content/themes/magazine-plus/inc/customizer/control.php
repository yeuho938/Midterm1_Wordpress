 ...
 */
class Magazine_Plus_Heading_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Magazine_Plus_Message_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Magazine_Plus_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Magazine_Plus_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	<label>
		...
		<select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), __( '&mdash; All &mdash;', 'magazine-plus' ) );
			?>
...
class Magazine_Plus_Dropdown_Sidebars_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Magazine_Plus_Customize_Section_Upsell extends WP_Customize_Section {

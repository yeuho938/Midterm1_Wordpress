 ...
 */
function tf_construction_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function tf_construction_sanitize_css( $css ) {
 ...
 */
function tf_construction_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function tf_construction_sanitize_email( $email, $setting ) {
 ...
 */
function tf_construction_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function tf_construction_sanitize_html( $html ) {
 ...
 */
function tf_construction_sanitize_image( $image, $setting ) {
 ...
 */
function tf_construction_sanitize_nohtml( $nohtml ) {
 ...
 */
function tf_construction_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function tf_construction_sanitize_number_range( $number, $setting ) {
 ...
 */
function tf_construction_sanitize_select( $input, $setting ) {
 ...
 */
function tf_construction_sanitize_url( $url ) {

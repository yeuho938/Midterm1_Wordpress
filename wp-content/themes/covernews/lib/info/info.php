        ...
        $config = array(
            ...
            'getting_started' => array(
                ...
                'five' => array(
                    ...
                    'description' => sprintf( esc_html__( 'Firstly, download demo files from %1$s page, then install and activate %2$s plugin. After that, import sample demo content, visit Import Demo Data menu under Appearance.', 'covernews' ), '<a target="_blank" href="https://afthemes.com/products/covernews/">CoverNews</a>', '<a href="https://wordpress.org/plugins/one-click-demo-import/" target="_blank">' . esc_html__( 'One Click Demo Import', 'covernews' ) . '</a>' ),
            ...
            //Demo content.
            'demo_content' => array(
                'description' => sprintf( esc_html__( 'Firstly, download demo files from %1$s page, then install and activate %2$s plugin. After that, to import sample demo content, visit Import Demo Data menu under Appearance.', 'covernews' ), '<a target="_blank" href="https://afthemes.com/products/covernews/">CoverNews</a>', '<a href="https://wordpress.org/plugins/one-click-demo-import/" target="_blank">' . esc_html__( 'One Click Demo Import', 'covernews' ) . '</a>' ),
            ),

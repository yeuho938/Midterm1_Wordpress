...
<?php _e( 'Skip to content', 'newslay' ); ?></a>
    <div class="wrapper">
        <header class="mg-headwidget center">
            ...
            $newsup_header_overlay_color = get_theme_mod('newsup_header_overlay_color','rgba(41,46,61,0.7)');?> style="background-color:<?php echo esc_attr($newsup_header_overlay_color);?>;" <?php } ?>> 
                <?php do_action('newslay_action_header_section'); ?>
              </div>
              </div>
          </div>
        ...
        <div class="container-fluid">
          <!-- Right nav -->
                    <div class="m-header align-items-center">
                        ...
                        <!-- navbar-toggle -->
                        <button class="navbar-toggler mx-auto" type="button" data-toggle="collapse" data-target="#navbar-wp" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation','newslay'); ?>">
...
<section class="mg-tpt-tag-area">
 ...
 do_action('newslay_action_front_page_main_section_1'); ?>
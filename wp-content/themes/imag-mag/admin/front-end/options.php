...
<div class="wrap" id="of_container">
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="header">
			...
			<div class="logo">
			<img src="<?php echo ADMIN_DIR; ?>assets/images/tp_panel1.png">				
			</div>
			<div class="theme_meta">
			<span>Theme Name:<?php echo THEMENAME; ?> - </span>
				<span>Theme Version <?php echo ('v'. THEMEVERSION); ?></span>
			</div>
		...
		<div class="save_bar"> 
			...
			<button id ="of_save" type="button" class="button-primary"><?php _e('Save All Changes','imagmag');?></button>			
			<button id ="of_reset" type="button" class="button submit-button reset-button" ><?php _e('Options Reset','imagmag');?></button>
